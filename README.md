...
| **Gemini** (Google) | • ตอบเร็ว<br>• ใช้งานได้กับคอมพิวเตอร์สเปคต่ำ<br>• มีโมเดลให้เลือกหลายระดับราคา | • ต้องต่ออินเทอร์เน็ต<br>• ข้อมูลถูกส่งออกนอกเครื่อง ไม่เหมาะกับเอกสาที่มีความรลับ<br>• ต้องสมัครและจัดการ API Key<br>• มีค่าใช้จ่ายตามจำนวน Token ที่ใช้ |
| **OpenAI** (GPT) | • ตอบเร็ว<br>• ใช้งานได้กับคอมพิวเตอร์สเปคต่ำ<br>• มีโมเดลให้เลือกหลายระดับราคา | • ต้องต่ออินเทอร์เน็ต<br>• ข้อมูลถูกส่งออกนอกเครื่อง ไม่เหมาะกับเอกสารที่มีความลับ<br>• ต้องสมัครและเติมเครดิตล่วงหน้า<br>• มีค่าใช้จ่ายตามจำนวน Token ที่ใช้ |

> **คำแนะนำในการเลือก:**
> - เอกสาร**ลับ/ภายใน** → ใช้ **Local AI**
> - เอกสาร**ทั่วไป** ต้องการความเร็วและความแม่นยำ → ใช้ **Gemini** หรือ **OpenAI**
> - คอมพิวเตอร์**สเปคต่ำ** → ใช้ **Gemini** หรือ **OpenAI**
