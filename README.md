...
1. **เลือก AI Model** เลือก Local AI, Gemini, หรือ OpenAI พร้อมกรอก API Key (ถ้าใช้ Cloud AI)
2. **กรอก Checklist และคะแนน** เพิ่มหัวข้อใหญ่และหัวข้อย่อยที่ต้องการตรวจสอบ
3. **อัปโหลด PDF** ลากไฟล์มาวางหรือคลิกเลือกไฟล์
4. **กด "ตรวจสอบ"** ระบบจะวิเคราะห์และแสดงผล
5. **ผลลัพธ์** แต่ละหัวข้อแสดงสถานะ ผ่าน / ไม่ผ่าน พร้อมหลักฐานจากเอกสาร และคะแนนรวม
...
สำหรับการวิเคราะห์ด้วย AI รองรับ 3 ช่องทาง: **Ollama** (Local) ที่ `localhost:11434`, **Gemini API** และ **OpenAI API** โดยผู้ใช้เลือก model ได้ผ่าน UI และ Backend เรียกใช้งานผ่าน **httpx** ทั้งหมด
โมเดล Local AI ที่แนะนำคือ **Gemma 4 (26B)** จาก Google แต่สามารถใช้โมเดลอื่นที่ติดตั้งใน Ollama ได้เช่นกัน
